...
class ADS1256:
    ...
    def ADS1256_WaitDRDY(self):
        ...
        while config.digital_read(self.drdy_pin) < 1:
            if(i > 800000):
                print("Time Out on wait for DRDY High...\r\n")
                break
            i += 1  
        i=0
        while config.digital_read(self.drdy_pin) > 0:
            if(i > 800000):
                print("Time Out on wait for DRDY Low...\r\n")
                break
            i += 1
    ...
    #Start Continuous Mode for ADC
    def ADS1256_StartContinuousADC(self):
        self.ADS1256_WaitDRDY()
    ...
    def ADS1256_StopContinuousADC(self):
        self.ADS1256_WaitDRDY()
